...
def test_pr141_plan_and_mapping_define_browser_acceptance_boundaries() -> None:
...
def test_pr141_handbook_uses_readable_wide_and_narrow_browser_images() -> None:
    expected = {
        "windows_strategy_period_chain_effect_probe_pr141_wide_2026-09-14.png": (
            1440,
            1000,
        ),
        "windows_strategy_period_chain_effect_probe_pr141_narrow_2026-09-14.png": (
            390,
            844,
        ),
    }
    ...
    assert handbook.count("aufgenommen am 2026-09-14") == 2
    assert "Zwei Perioden starten" in handbook
    assert "Uebergang 1 nach 2" in handbook


def test_pr141_sources_are_indexed() -> None:
