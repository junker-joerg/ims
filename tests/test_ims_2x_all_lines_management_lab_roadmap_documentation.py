...
def test_active_roadmap_numbers_pr142_through_pr182_without_gaps() -> None:
    ...
    assert "PR148 umgesetzt, PR149 naechster Schritt" in document
    ...
    assert "technischer 100-Perioden-Lauf | PR149 | 8 | 1" in document
    assert "kontrollierte Managementseminar-Reife | PR182 | 41 | 34" in document
