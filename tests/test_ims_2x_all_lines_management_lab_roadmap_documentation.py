...
def test_active_roadmap_numbers_pr142_through_pr182_without_gaps() -> None:
    ...
    assert "PR147 umgesetzt, PR148 naechster Schritt" in document
    ...
    assert "technischer 100-Perioden-Lauf | PR149 | 8 | 2" in document
    assert "kontrollierte Managementseminar-Reife | PR182 | 41 | 35" in document
