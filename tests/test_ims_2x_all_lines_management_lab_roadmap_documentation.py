...
def test_active_roadmap_numbers_pr142_through_pr182_without_gaps() -> None:
    ...
    assert "PR146 umgesetzt, PR147 naechster Schritt" in document
    ...
    assert "technischer 100-Perioden-Lauf | PR149 | 8 | 3" in document
    assert "kontrollierte Managementseminar-Reife | PR182 | 41 | 36" in document
