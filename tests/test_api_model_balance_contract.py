...
def test_model_balance_contract_endpoint_is_read_only_without_execution(
    ...
    def reject_execution(*args: object, **kwargs: object) -> None:
        raise AssertionError("Der Bilanzvertrag darf keinen Runner starten")

    monkeypatch.setattr(runner, "run_loaded_explicit_period", reject_execution)
    client = TestClient(create_app(frontend_dist=tmp_path))
    endpoint = "/api/accounting/model-balance-contract"
