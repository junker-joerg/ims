...
def _build_reference_sample() -> tuple[SimulationContext, BAV, list[Insurer], list[Policyholder]]:
    ...
    insurers = [
        Insurer(entity_id=200, active=True, rule_id=2, rule_class=1, premiums_current=10.0, advertising_current=2.0, reserves_current=[50.0, 50.0], policyholders_current=100.0, claims_count_current=[1, 2], claims_sum_current=[5.0, 10.0]),
        Insurer(entity_id=201, active=True, rule_id=2, rule_class=1, premiums_current=20.0, advertising_current=4.0, reserves_current=[70.0, 70.0], policyholders_current=120.0, claims_count_current=[3, 4], claims_sum_current=[7.0, 12.0]),
        Insurer(entity_id=202, active=True, rule_id=3, rule_class=2, premiums_current=30.0, advertising_current=6.0, reserves_current=[90.0, 90.0], policyholders_current=140.0, claims_count_current=[5, 6], claims_sum_current=[9.0, 14.0]),
    ]
    policyholders = [
