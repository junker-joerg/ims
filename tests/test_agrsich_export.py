...
def _build_export_sample() -> tuple[SimulationContext, BAV, list[Insurer], list[Policyholder]]:
    ...
    insurers = [
        Insurer(entity_id=200, active=True, rule_id=1, rule_class=10, premiums_current=10.0, advertising_current=2.0, reserves_current=[50.0, 50.0], policyholders_current=100.0, claims_count_current=[1, 3], claims_sum_current=[5.0, 15.0]),
        Insurer(entity_id=201, active=True, rule_id=1, rule_class=10, premiums_current=20.0, advertising_current=6.0, reserves_current=[70.0, 70.0], policyholders_current=120.0, claims_count_current=[3, 5], claims_sum_current=[9.0, 21.0]),
        Insurer(entity_id=202, active=True, rule_id=2, rule_class=20, premiums_current=40.0, advertising_current=10.0, reserves_current=[90.0, 90.0], policyholders_current=80.0, claims_count_current=[5, 7], claims_sum_current=[13.0, 25.0]),
        Insurer(entity_id=203, active=False, rule_id=2, rule_class=20, premiums_current=999.0, advertising_current=999.0, reserves_current=[999.0, 999.0], policyholders_current=999.0, claims_count_current=[9, 9], claims_sum_current=[99.0, 99.0]),
    ]
    policyholders = [
