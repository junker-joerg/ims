...
def test_scenario_loader_allows_vu_random_rule_snapshots_without_explicit_draws() -> None:
    scenario = load_scenario_from_mapping(
        {
            "context": {"period": 2, "max_periods": 3, "rng_seed": 123},
            "bav": {"entity_id": 1, "name": "BAV"},
            "insurers": [{"entity_id": 10, "name": "VU"}, {"entity_id": 11, "name": "VU-11"}],
            "policyholders": [],
            "vu_random_uniform_rule_snapshots": [
    ...
    assert scenario.vu_random_uniform_rule_snapshots[0].random_draws is None
    assert scenario.vu_random_normal_rule_snapshots[0].normal_draws is None
