...
def test_two_scheduled_events_run_in_logtime_order_within_same_period() -> None:
    result = run_two_scheduled_bav_updates("tests/fixtures/minimal_scenario.json")
...
def test_two_scheduled_events_can_cross_period_boundary() -> None:
...
def test_two_scheduled_events_rng_samples_are_deterministic() -> None:
...
def test_two_scheduled_events_raise_when_sampling_without_rng() -> None:
