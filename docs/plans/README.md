...
- `ims_2x_strategy_assignment_draft_plan.md`: PR108-Plan fuer das versionierte
  Vdefmd6-Entwurfsformat und seine zustandslose Validierung, ohne Speicherung,
  Snapshot-Uebersetzung oder Ausfuehrung.
- `ims_2x_strategy_assignment_snapshot_translation_plan.md`: PR110-Plan fuer
...
- `ims_2x_strategy_assignment_snapshot_translation_ui_plan.md`: PR111-Plan
  ...
  Ausfuehrung.
- `ims_2x_strategy_assignment_snapshot_context_plan.md`: PR112-Plan fuer den
...
- `ims_2x_strategy_assignment_snapshot_materialization_ui_plan.md`: PR117-
  Plan fuer die rein lesende Workbench-Vorschau vollstaendig materialisierter
  VN-Snapshots, weiterhin ohne Speicherung, Runner oder Simulation.
...
- `ims_2x_strategy_assignment_vu_snapshot_state_validation_plan.md`:
...
- `ims_2x_strategy_execution_period_chain_validation_plan.md`: PR134-Plan
  ...
  bis 100 Perioden; Kettenbau und Ausfuehrung bleiben gesperrt.
- `ims_2x_strategy_execution_period_chain_resolution_plan.md`: PR135-Plan
...
- `ims_2x_pr166_life_result_delivery_plan.md`:
  PR166-Plan fuer kontrollierte Lebens-Vorschau, digestgebundene
  Ergebnisablage, read-only Verlauf und XLSX-Export.
...
- `ims_2x_pr169_health_balance_and_simulation_plan.md`:
  ...
  PR169b-Periodenkette; verbindliche PR169c-d-Folge fuer eine bedienbare
...
- `ims_2x_windows_ready_to_run_packaging_plan.md`:
  ...
  Python-, Node- oder Skriptpflicht auf dem Zielrechner; PR169c-d gehen vor.
