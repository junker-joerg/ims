...
- VN-Agrsich: `IMSVNR01.DAT`, `IMSVNR02.DAT`, `IMSVNR05.DAT`, `IMSVNSK1.DAT`

## Naheliegende nächste Kandidaten

- Weitere VN-Regeldateien aus `IMSVNR03.DAT`, `IMSVNR04.DAT` und
  `IMSVNR06.DAT`.
...
- `IMSVNR03.DAT` und `IMSVNR04.DAT`;
- danach `IMSVNR06.DAT` und Abgleich der vollstaendigen IMSVNR-Familie;
