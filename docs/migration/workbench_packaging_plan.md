...
Der Packaging-/Bereitstellungsblock bleibt grob bei ca. `3-9` reviewbaren PRs nach diesem Schritt:
...
- Packaging und Bereitstellung: ca. `3-9` PRs.
- Integrations- und Review-Reserve: ca. `3-5` PRs.

Erwartet bleiben damit weiterhin grob ca. `25-42+` reviewbare PRs. Diese Zahl ist bewusst konservativ und kann durch Fachvalidierung oder Plattform-/Packaging-Fallen steigen.
