...
100 IMS-Perioden; siehe `ims_2x_health_period_chain.md`. `PR169c` hat
geschuetzte Ablage und CSV/JSON/XLSX geliefert. `PR169d` bringt erst den
bedienbaren Workbench-Pfad mit Baseline/Variante. **PR169 selbst startet
weder Runner noch Simulation**.
